        ...
        <a-table :columns="tableColumns" :data-source="clientList"
          ...
          <template slot="action" slot-scope="record">
            <a-button type="link" size="small"
              @click="toClientDetail(record.client_id)">
              查看详情
            </a-button>
  ...
  methods: {
    ...
    showEditModal (info) {
      ...
      if (info) {
        this.isEdit = true
        this.title = '编辑申办方信息'
        this.clientForm = Object.assign(this.clientForm, info, {})
      }
    },
    editOk () {
    ...
    toClientDetail (client_id) {
      this.$router.push({ name: 'wms_client_detail', params: { id: client_id } })
    },
    reloadList () {
      this.getClientList()
    },
