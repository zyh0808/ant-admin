  ...
  <div class="wms-site">
    ...
    <div class="content">
          ...
          <a-row class="searchRow">
            ...
            <a-col :span="6">
              <a-form-model-item label="所在城市">
                <a-input v-model="searchForm.site_city" placeholder="请输入" allowClear />
              </a-form-model-item>
            </a-col>
            <a-col :span="6">
      ...
      <div class="site-table">
        ...
        <a-table :columns="tableColumns" :data-source="siteList" class="table-one" :rowKey="record => record.site_id" :loading="isfetchSiteList" :pagination="false" :scroll="{x: 1700}">
          ...
          <template slot="action" slot-scope="record">
            ...
            <a-popconfirm v-if="siteList.length" title="确认删除吗?" cancelText="取消" okText="确认" @confirm="() => deleteSite(record.site_id)">
      ...
      <a-modal :title="title" :visible="isShowEditModal" :confirm-loading="confirmLoading" @ok="editOk" @cancel="editCancel" cancelText="取消" okText="确定" :width="800">
        <a-form-model ref="siteFormRef" :model="siteForm" :rules="siteFormRules" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
          <a-row>
            <a-col :span="12">
              <a-form-model-item label="实验中心编码" prop="site_code" ref="site_code">
          ...
          () => {
            ...
            <a-col :span="12">
              <a-form-model-item label="实验中心名称" prop="site_name" ref="site_name">
          ...
          <a-row>
            <a-col :span="12">
              <a-form-model-item label="联系人" prop="site_person" ref="site_person">
          ...
          () => {
            ...
            <a-col :span="12">
              <a-form-model-item label="联系电话" prop="site_phone" ref="site_phone">
          ...
          <a-row>
            <a-col :span="12">
              <a-form-model-item label="合同编号" prop="contracts_code" ref="contracts_code">
                <a-input v-model="siteForm.contracts_code" placeholder="请输入" @blur="
          () => {
          ...
          <a-row>
            <a-col :span="12">
              <a-form-model-item label="销售员" prop="current_salesman" ref="current_salesman">
                <a-input v-model="siteForm.current_salesman" placeholder="请输入" @blur="
          () => {
          ...
          <a-form-model-item label="发票抬头" prop="invoice_head" ref="invoice_head" :label-col="{ span: 4 }" :wrapper-col="{ span: 20 }">
