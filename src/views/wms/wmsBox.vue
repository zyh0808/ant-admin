  ...
  data () {
    ...
    return {
      ...
      boxFormRules: {
        ...
        // category: [{ required: true, message: '请选择箱型类别', trigger: 'blur' }],
        box_kind_id: [{ required: true, message: '请选择箱型', trigger: 'blur' }],
        drug_count: [{ required: true, message: '请输入药品数量', trigger: 'blur' }],
        // box_length: [{ required: true, message: '请输入长度', trigger: 'blur' }],
        // box_width: [{ required: true, message: '请输入宽度', trigger: 'blur' }],
        // box_height: [{ required: true, message: '请输入高度', trigger: 'blur' }],
        // box_weight: [{ required: true, message: '请输入重量', trigger: 'blur' }],
        // box_volume_rate: [{ required: true, message: '请输入容积率', trigger: 'blur' }]
      },
      isEdit: false,
      boxInfo: {},
