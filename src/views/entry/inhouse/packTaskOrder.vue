<template>
  <div class="pack-task-order"
    @scroll="handleScroll($event)">
    <div class="title">
      <pageHeader :routes="pageHeaderRoutes"
        :basePath="system"></pageHeader>
    </div>
    <div class="pack-task-order-content">
      <packTaskSearch ref="packSearchRef"
        :pagination="pagination"
        @changePagination="changePagination">
      </packTaskSearch>
      <packList ref="packTaskListRef"
        :pagination="pagination"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      packListTotal: 'inhouse/packListTotal'
    })
  },
  methods: {
    ...mapMutations({
    ...
    changePagination () {
      this.pagination.total = this.packListTotal
    },
