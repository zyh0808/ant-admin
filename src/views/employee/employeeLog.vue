    ...
    <div class="content">
          ...
          <a-row class="searchRow">
            <a-col :span="8">
              <a-form-model-item label="操作时间">
                <a-range-picker v-model="searchForm.searchDate"
                  :format="dateFormat" />
              </a-form-model-item>
            </a-col>
            <a-col :span="6">
      ...
      <div class="employee-log-table">
        ...
        <a-table :columns="tableColumns" ref="tableRef"
          :data-source="logPageList" class="table-list"
          :rowKey="record => record.log_id" :pagination="pagination"
          @change="handleTableChange" @showSizeChange="onShowSizeChange"
          :loading="isfetchLogPageList" :scroll="{x:1200}">
        </a-table>
  ...
  methods: {
    ...
    getLogList () {
      ...
      this.fetchLogPageList({
        ...
        type_code: this.searchForm.type_code === undefined ? -1 : this.searchForm.type_code,
        result_code: '',
