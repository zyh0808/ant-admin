<template>
  <div class="employee-org" @scroll="handleScroll($event)">
    ...
    <div class="content">
      <a-row class="content-row">
        ...
        <a-col :span="19" style="height:100%">
          <a-card title="组织机构信息" class="right-card" :bordered="false"
            ref="contentRowRefs">
            <div class="employee-sys-table">
              ...
              <a-table :columns="tableColumns" ref="tableRef"
                :data-source="orgList" class="table-list"
                :rowKey="record => record.org_id" :pagination="false"
                :loading="isfetchOrgList" :scroll="{x:1050}">
                ...
                <template slot="action" slot-scope="record">
                  ...
                  <a-popconfirm v-if="orgList.length" title="确认删除吗?"
                    cancelText="取消" okText="确认"
                    @confirm="() => deleteOrg(record.org_id)">
                    <a-button type="link" size="small">
                      删除
                    </a-button>
                  </a-popconfirm>
    ...
    <a-modal :title="title" :visible="isShowEditModal"
      ...
      <a-form-model ref="orgFormRef" :model="orgForm" :rules="orgFormRules"
        ...
        <a-row>
          <a-col :span="12">
            <a-form-model-item label="机构名称" prop="org_name" ref="org_name">
              <a-input v-model="orgForm.org_name" :max-length="100"
          ...
          <a-col :span="12">
            <a-form-model-item label="机构简称" prop="short_name" ref="short_name">
              <a-input v-model="orgForm.short_name" :max-length="50"
                placeholder="请输入" @blur="
          () => {
        ...
        <a-row>
          <a-col :span="12">
            <a-form-model-item label="英文名称" prop="en_name" ref="en_name">
              <a-input v-model="orgForm.en_name" :max-length="50"
                placeholder="请输入" @blur="
          () => {
        ...
        <a-row>
          <a-col :span="12">
            <a-form-model-item label="负责人" prop="manager" ref="manager">
              <a-input v-model="orgForm.manager" :max-length="20"
                placeholder="请输入" @blur="
          () => {
        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-model-item label="传真" prop="fax" ref="fax">
              <a-input v-model="orgForm.fax" :max-length="50" placeholder="请输入"
                @blur="
          () => {
        ...
        <a-row>
          <a-col :span="12">
            <a-form-model-item label="省份" prop="province_id">
              <a-select v-model="orgForm.province_id" @select="fetchCityList"
                :loading="isfetchProvinceList" placeholder="请选择">
          ...
          <a-col :span="12">
            <a-form-model-item label="市区" prop="city_id">
              <a-select v-model="orgForm.city_id" @select="fetchCountyList"
        ...
        <a-row>
          <a-col :span="12">
            <a-form-model-item label="县/区" prop="county_id">
              <a-select v-model="orgForm.county_id" @select="fetchTownList"
          ...
          <a-col :span="12">
            <a-form-model-item label="街道/镇" prop="town_id">
              <a-select v-model="orgForm.town_id" @select="fetchVillageList"
        ...
        <a-row>
          <a-col :span="12">
            <a-form-model-item label="社区/村" prop="village_id">
              <a-select v-model="orgForm.village_id"
          ...
          <a-col :span="12">
            <a-form-model-item label="邮政编码" prop="postcode" ref="postcode">
              <a-input v-model="orgForm.postcode" :max-length="6"
                placeholder="请输入" @blur="
          () => {
        ...
        <a-form-model-item label="公司地址" prop="addr" ref="addr"
          :label-col="{ span: 3 }" :wrapper-col="{ span: 20 }">
          <a-input v-model="orgForm.addr" :max-length="100" placeholder="请输入"
            @blur="
          () => {
        ...
        <a-form-model-item label="备注" :label-col="{ span: 3 }"
          :wrapper-col="{ span: 20 }">
          <a-input v-model="orgForm.memo" type="textarea" :max-length="200"
            placeholder="请输入" />
        </a-form-model-item>
      </a-form-model>
    </a-modal>
